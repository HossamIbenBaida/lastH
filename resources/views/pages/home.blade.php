        ...
        <div class="tg-search-category">
            <div class="tg-displaytable">
                ...
                <div class="tg-displaytablecell">
                    <div class="tg-box">
                        <a href="#"><h3>find your doctor</h3></a>
    ...
    <div class="col-sm-4 col-xs-12 tg-expectwidth">
        <div class="tg-search-category">
            <div class="tg-displaytable">
                ...
                <div class="tg-displaytablecell">
                    <div class="tg-box">
                        <a href=#"><h3>NEAREST HOSPITAL</h3></a>
    ...
    <div class="col-sm-4 col-xs-12 tg-expectwidth">
        <div class="tg-search-category">
            <div class="tg-displaytable">
                ...
                <div class="tg-displaytablecell">
                    <div class="tg-box">
                        <a href="#"><h3>NEAREST PHARMACY</h3></a>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-6 tg-feedbackwidht">
                                <div class="tg-patientfeedback">
                                    <figure class="tg-patient-pic">
                                        <a href="#
"><img src="http://santemap.firstonenews.com/wp-content/uploads/2016/04/img-01-1-150x150.jpg" alt="Reviewer"></a>
                                    </figure>
                                    <div class="tg-patient-message">
                                        <span class="tg-patient-name"><a href="#">Dr Steve</a></span>
                                        <span class="tg-doctor-name">For <a href="#">Demo Professional</a></span>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-6 tg-feedbackwidht">
                                <div class="tg-patientfeedback">
                                    <figure class="tg-patient-pic">
                                        <a href="#"><img src="http://santemap.firstonenews.com/wp-content/uploads/2016/04/img-01-1-150x150.jpg" alt="Reviewer"></a>
                                    </figure>
                                    <div class="tg-patient-message">
                                        <span class="tg-patient-name"><a href="#">Dr Steve</a></span>
                                        <span class="tg-doctor-name">For <a href="#">Dr.Carol</a></span>
                                        <div class="tg-stars star-rating">
                        ...
                        <div class="tg-findbycategory">
                            <div class="tg-box">
                                ...
                                <ul>
                                    ...
                                    <li><a href="#">Altrincham</a></li>
                                    <li><a href="#">Aylesbury</a></li>
                                    <li><a href="#">Bamber</a></li>
                                    <li><a href="#">Bangor</a></li>
                                    <li><a href="#">Batley</a></li>
                                    <li><a href="#">Bebingto</a></li>
                                    ...
                                    <li><a href="#">Crawley</a></li>
                                    <li><a href="#">Darlington</a></li>
                                    <li><a href="#">Eastleigh</a></li>
                                    <li><a href="#">Edinburg</a></li>
                                    <li><a href="#">Esher</a></li>
                                    <li><a href="#">Glasgow SCO</a></li>
                                    <li><a href="#">Guildford</a></li>
                                    <li><a href="#">Halesowen</a></li>
                                    <li><a href="#">Halifax</a></li>
                                    <li><a href="#">Hamilton</a></li>
                                    <li><a href="#">Inezgane</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="sc-dir-search sc-specialities">
                        <div class="tg-findbycategory">
                            <div class="tg-box">
                                ...
                                <ul>
                                    <li><a href="#">Aerobic Centers</a></li>
                                    <li><a href="#">Associazione Volontari</a></li>
                                    <li><a href="#">Athletic Clubs</a></li>
                                    <li><a href="#">Blood Services</a></li>
                                    <li><a href="#">Blood Services Center</a></li>
                                    <li><a href="#">Cancer Hospital</a></li>
                                    <li><a href="#">Cardiologist</a></li>
                                    <li><a href="#">Cardiology clinic</a></li>
                                    <li><a href="#">Children clinic</a></li>
                                    <li><a href="#">Children Hospital</a></li>
                                    <li><a href="#">Clinical pharmacy</a></li>
                                    <li><a href="#">Colorectal surgeon</a></li>
                                    <li><a href="#">Community Blood Services</a></li>
                                    <li><a href="#">Community pharmacy</a></li>
                                    <li><a href="#">Compliance (medicine)</a></li>
                                    <li><a href="#">Cord Blood Registry</a></li>
                                    <li><a href="#">Country Clubs</a></li>
                                    <li><a href="#">Dance Centers</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
